...
object GameRepositoryImpl : GameRepository {
    ...
    private const val MIN_ANSVER_VALUE = 1
    ...
    override fun generateQuestion(maxSumValue: Int, countOfOptions: Int): Question {
        ...
        val visibleNumber = Random.nextInt(MIN_ANSVER_VALUE, sum)
        ...
        val from = max(rightAnswer - countOfOptions, MIN_ANSVER_VALUE) //если разность будет меньше 1(правильный ответ будет 4 например), то будет использовано минимальное значение
